...
class ConnectionManager
{
	...
	{
		return $this->byId( "eexam_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "eexam_at_localhost";
		$data["connName"] = "eexam at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;eexam;;1"; //currently unused
		
		$this->_connectionsIdByName["eexam at localhost"] = "eexam_at_localhost";
...
;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["admin_rights"] = "eexam_at_localhost";
		$connectionsIds["user"] = "eexam_at_localhost";
		$connectionsIds["admin_members"] = "eexam_at_localhost";
		$connectionsIds["admin_users"] = "eexam_at_localhost";
		$connectionsIds["analisa_kelulusan_psra_sek"] = "eexam_at_localhost";
		$connectionsIds["gps_psra_sek"] = "eexam_at_localhost";
		$connectionsIds["analisa_subjek_psra_sek"] = "eexam_at_localhost";
		$connectionsIds["purata_psra_sek"] = "eexam_at_localhost";
		$connectionsIds["analisa_kelulusan_psra_daerah"] = "eexam_at_localhost";
		$connectionsIds["gps_psra_daerah"] = "eexam_at_localhost";
		$connectionsIds["analisa_subjek_psra_daerah"] = "eexam_at_localhost";
		$connectionsIds["purata_psra_daerah"] = "eexam_at_localhost";
		$connectionsIds["analisa_kelulusan_psra_all"] = "eexam_at_localhost";
		$connectionsIds["gps_psra_all"] = "eexam_at_localhost";
		$connectionsIds["analisa_subjek_psra_all"] = "eexam_at_localhost";
		$connectionsIds["purata_psra_all"] = "eexam_at_localhost";
		$connectionsIds["carta_kelulusan_psra_all"] = "eexam_at_localhost";
		$connectionsIds["carta_pangkat_psra_all"] = "eexam_at_localhost";
		$connectionsIds["archive_exam_marking"] = "eexam_at_localhost";
		$connectionsIds["result_psra"] = "eexam_at_localhost";
		$connectionsIds["semakan_duplicate"] = "eexam_at_localhost";
		$connectionsIds["daftar_sek"] = "eexam_at_localhost";
		$connectionsIds["daftar_daerah"] = "eexam_at_localhost";
		$connectionsIds["daftar_all"] = "eexam_at_localhost";
		$connectionsIds["pendaftaran_murid"] = "eexam_at_localhost";
		$connectionsIds["pendaftaran_sekolah"] = "eexam_at_localhost";
		$connectionsIds["marking_AS"] = "eexam_at_localhost";
		$connectionsIds["marking_BA"] = "eexam_at_localhost";
		$connectionsIds["marking_JIK"] = "eexam_at_localhost";
