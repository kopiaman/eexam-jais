...
require_once("include/dashboard_utama_variables.php");
...
$page_layouts["dashboard_utama_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("dashboard_utama", "dashboard");
