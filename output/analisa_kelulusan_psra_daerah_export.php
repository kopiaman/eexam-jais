...
require_once("include/analisa_kelulusan_psra_daerah_variables.php");
...
$page_layouts["analisa_kelulusan_psra_daerah_export"] = $layout;
...
if( @$_REQUEST["a"] != "" )
{
	...
	if (@$_REQUEST["mdelete"])
	{
		...
		{
			$keys=array();
			$keys["eYear"] = refine($_REQUEST["mdelete1"][mdeleteIndex($ind)]);
			$selected_recs[] = $keys;
		}
	}
