...
class AuditTrailTable
{
	...
	function logValueEnable($table)
	{
		...
		if($table=="analisa_kelulusan_psra_sek")
		{
			return false;
		}
		if($table=="gps_psra_sek")
		{
			return false;
		}
		if($table=="analisa_subjek_psra_sek")
		{
			return false;
		}
		if($table=="purata_psra_sek")
		{
			return false;
		}
		if($table=="analisa_kelulusan_psra_daerah")
		{
			return false;
		}
		if($table=="gps_psra_daerah")
		{
			return false;
		}
		if($table=="analisa_subjek_psra_daerah")
		{
			return false;
		}
		if($table=="purata_psra_daerah")
		{
			return false;
		}
		if($table=="analisa_kelulusan_psra_all")
		{
			return false;
		}
		if($table=="gps_psra_all")
		{
			return false;
		}
		if($table=="analisa_subjek_psra_all")
		{
			return false;
		}
		...
		if($table=="archive_exam_marking")
		{
			return false;
		}
		if($table=="result_psra")
		{
			return false;
		}
		if($table=="semakan_duplicate")
		{
			return false;
		}
		if($table=="daftar_sek")
		...
		if($table=="pendaftaran_murid")
		{
			return false;
		}
		if($table=="pendaftaran_sekolah")
		{
			return false;
		}
		if($table=="marking_AS")
