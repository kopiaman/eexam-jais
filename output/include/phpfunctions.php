...
;
	...
	{
		$gred=$data['mumtaz'];
$calonHadir=$data['calonHadir'];
$peratus=$gred/$calonHadir*100;

if($peratus!=0){
$value=number_format($peratus,1).'%';
}else{$value='';};
;
		return $value;
	}
				if($table=="analisa_kelulusan_psra_sek" && $field=="JJpercent")
	{
		$gred=$data['JJ'];
$calonHadir=$data['calonHadir'];
$peratus=$gred/$calonHadir*100;
...
$value=number_format($peratus,1).'%';
		...
		return $value;
				...
				if($table=="analisa_kelulusan_psra_sek" && $field=="Jpercent")
	{
		$gred=$data['jidan'];
$calonHadir=$data['calonHadir'];
$peratus=$gred/$calonHadir*100;
...
$value=number_format($peratus,1).'%';
		...
		return $value;
				...
				if($table=="analisa_kelulusan_psra_sek" && $field=="MQpercent")
	{
		$gred=$data['maqbul'];
$calonHadir=$data['calonHadir'];
$peratus=$gred/$calonHadir*100;
...
$value=number_format($peratus,1).'%';
		...
		return $value;
				...
				if($table=="gps_psra_sek" && $field=="skor")
	{
...
;
		return $value;
				...
				if($table=="analisa_kelulusan_psra_daerah" && $field=="Mpercent")
	{
		$gred=$data['mumtaz'];
$calonHadir=$data['calonHadir'];
$peratus=$gred/$calonHadir*100;
...
;
		return $value;
				...
				if($table=="analisa_kelulusan_psra_daerah" && $field=="JJpercent")
	{
		$gred=$data['JJ'];
$calonHadir=$data['calonHadir'];
$peratus=$gred/$calonHadir*100;
...
$value=number_format($peratus,1).'%';
		...
		return $value;
				...
				if($table=="analisa_kelulusan_psra_daerah" && $field=="Jpercent")
	{
		$gred=$data['jidan'];
$calonHadir=$data['calonHadir'];
$peratus=$gred/$calonHadir*100;
...
$value=number_format($peratus,1).'%';
		...
		return $value;
				...
				if($table=="analisa_kelulusan_psra_daerah" && $field=="MQpercent")
	{
		$gred=$data['maqbul'];
$calonHadir=$data['calonHadir'];
$peratus=$gred/$calonHadir*100;
...
$value=number_format($peratus,1).'%';
		...
		return $value;
				...
				if($table=="gps_psra_daerah" && $field=="skor")
	{
...
;
		return $value;
				...
				if($table=="analisa_kelulusan_psra_all" && $field=="Mpercent")
	{
		$gred=$data['mumtaz'];
$calonHadir=$data['calonHadir'];
$peratus=$gred/$calonHadir*100;
...
;
		return $value;
				...
				if($table=="analisa_kelulusan_psra_all" && $field=="JJpercent")
	{
		$gred=$data['JJ'];
$calonHadir=$data['calonHadir'];
$peratus=$gred/$calonHadir*100;
...
$value=number_format($peratus,1).'%';
		...
		return $value;
				...
				if($table=="analisa_kelulusan_psra_all" && $field=="Jpercent")
	{
		$gred=$data['jidan'];
$calonHadir=$data['calonHadir'];
$peratus=$gred/$calonHadir*100;
...
$value=number_format($peratus,1).'%';
		...
		return $value;
				...
				if($table=="analisa_kelulusan_psra_all" && $field=="MQpercent")
	{
		$gred=$data['maqbul'];
$calonHadir=$data['calonHadir'];
$peratus=$gred/$calonHadir*100;
...
$value=number_format($peratus,1).'%';
		...
		return $value;
				...
				if($table=="gps_psra_all" && $field=="skor")
	{
...
;
		return $value;
				...
				if($table=="result_psra" && $field=="s1")
	{
		
$totalMarkah=$data['s1'];
if($totalMarkah=='TH'){
$pangkat='TH';
}else if($totalMarkah>=90){
$pangkat='MZ';
}else if($totalMarkah>=75){
$pangkat='JJ';
}else if($totalMarkah>=60){
$pangkat='J';
}else if($totalMarkah>=40){
$pangkat='MQ';
}else if($totalMarkah<40){
$pangkat='MS';
}else{
...
$value=$pangkat;;
		return $value;
				...
				if($table=="result_psra" && $field=="pangkat")
	{
		
$totalMarkah=$data['peratus'];
$TH=$data['tidakHadir'];
if($TH==1){
$pangkat='TH';
}else if($totalMarkah>=0.9){
$pangkat='Mumtaz</font>';
}else if($totalMarkah>=0.75){
$pangkat='Jayyid Jidan';
}else if($totalMarkah>=0.6){
$pangkat='Jidan';
}else if($totalMarkah>=0.4){
$pangkat='Maqbul';
}else if($totalMarkah<0.4){
$pangkat='Muasadah';
}else{
...
$value=$count_row['bil'];;
		return $value;
				...
				if($table=="pendaftaran_sekolah" && $field=="opt")
	{
		$value="";;
		return $value;
	}
...
function GetLWWhere($field, $ptype, $table = "")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="exam_marking" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="semakan" && $field=="sZone")
	{
		return "catID=2";
				...
				if($table=="school" && $field=="sZone" && $ptype=="edit")
	{
		return " catID =2 ";
	}
				if($table=="school" && $field=="sZone" && $ptype=="add")
	{
		return " catID =2 ";
	}
				if($table=="school" && $field=="sZone" && $ptype=="search")
	{
		return " catID =2 ";
	}
				if($table=="admin_users" && $field=="zon")
	{
		return "catID=2";
	}
				if($table=="analisa_kelulusan_psra_sek" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="gps_psra_sek" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="analisa_subjek_psra_sek" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="purata_psra_sek" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="analisa_kelulusan_psra_daerah" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="gps_psra_daerah" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="analisa_subjek_psra_daerah" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="purata_psra_daerah" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="archive_exam_marking" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="result_psra" && $field=="sZone")
	{
		return "catID=2";
				...
				if($table=="daftar_sek" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="daftar_daerah" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="pendaftaran_murid" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="pendaftaran_sekolah" && $field=="sZone" && $ptype=="edit")
	{
		return " catID =2 ";
	}
				if($table=="pendaftaran_sekolah" && $field=="sZone" && $ptype=="add")
	{
		return " catID =2 ";
	}
				if($table=="pendaftaran_sekolah" && $field=="sZone" && $ptype=="search")
	{
		return " catID =2 ";
	}
				if($table=="marking_AS" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="marking_BA" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="marking_JIK" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="marking_TF" && $field=="sZone")
	{
		return "catID=2";
	}
				if($table=="marking_TJ" && $field=="sZone")
	{
		return "catID=2";
	}
