...
class tDAL
{
	var $tbleexam_at_localhost__exam_marking;
	var $tbleexam_at_localhost__school;
	var $tbleexam_at_localhost__setting;
	var $tbleexam_at_localhost__setting_category;
	var $tbleexam_at_localhost__user;
	var $tbleexam_at_localhost__user_uggroups;
	var $tbleexam_at_localhost__user_ugmembers;
	var $tbleexam_at_localhost__user_ugrights;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "exam_marking", "varname" => "eexam_at_localhost__exam_marking", "altvarname" => "exam_marking", "connId" => "eexam_at_localhost", "schema" => "", "connName" => "eexam at localhost");
		$this->lstTables[] = array("name" => "school", "varname" => "eexam_at_localhost__school", "altvarname" => "school", "connId" => "eexam_at_localhost", "schema" => "", "connName" => "eexam at localhost");
		$this->lstTables[] = array("name" => "setting", "varname" => "eexam_at_localhost__setting", "altvarname" => "setting", "connId" => "eexam_at_localhost", "schema" => "", "connName" => "eexam at localhost");
		$this->lstTables[] = array("name" => "setting_category", "varname" => "eexam_at_localhost__setting_category", "altvarname" => "setting_category", "connId" => "eexam_at_localhost", "schema" => "", "connName" => "eexam at localhost");
		$this->lstTables[] = array("name" => "user", "varname" => "eexam_at_localhost__user", "altvarname" => "user", "connId" => "eexam_at_localhost", "schema" => "", "connName" => "eexam at localhost");
		$this->lstTables[] = array("name" => "user_uggroups", "varname" => "eexam_at_localhost__user_uggroups", "altvarname" => "user_uggroups", "connId" => "eexam_at_localhost", "schema" => "", "connName" => "eexam at localhost");
		$this->lstTables[] = array("name" => "user_ugmembers", "varname" => "eexam_at_localhost__user_ugmembers", "altvarname" => "user_ugmembers", "connId" => "eexam_at_localhost", "schema" => "", "connName" => "eexam at localhost");
		$this->lstTables[] = array("name" => "user_ugrights", "varname" => "eexam_at_localhost__user_ugrights", "altvarname" => "user_ugrights", "connId" => "eexam_at_localhost", "schema" => "", "connName" => "eexam at localhost");
	}
