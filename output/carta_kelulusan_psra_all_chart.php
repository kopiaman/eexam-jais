...
require_once("include/carta_kelulusan_psra_all_variables.php");
...
$layout = new TLayout("chart5", "Coral1Coral1", "MobileCoral1");
$layout->version = 2;
...
$page_layouts["carta_kelulusan_psra_all_chart"] = $layout;
