...
function GetTableURL($table = "")
{
	...
	if("admin_users" == $table)
		return "admin_users";
	if("analisa_kelulusan_psra_sek" == $table)
		return "analisa_kelulusan_psra_sek";
	if("gps_psra_sek" == $table)
		return "gps_psra_sek";
	if("analisa_subjek_psra_sek" == $table)
		return "analisa_subjek_psra_sek";
	if("purata_psra_sek" == $table)
		return "purata_psra_sek";
	if("analisa_kelulusan_psra_daerah" == $table)
		return "analisa_kelulusan_psra_daerah";
	if("gps_psra_daerah" == $table)
		return "gps_psra_daerah";
	if("analisa_subjek_psra_daerah" == $table)
		return "analisa_subjek_psra_daerah";
	if("purata_psra_daerah" == $table)
		return "purata_psra_daerah";
	if("analisa_kelulusan_psra_all" == $table)
		return "analisa_kelulusan_psra_all";
	if("gps_psra_all" == $table)
		return "gps_psra_all";
	if("analisa_subjek_psra_all" == $table)
	...
	if("archive_exam_marking" == $table)
		return "archive_exam_marking";
	if("result_psra" == $table)
		return "result_psra";
	if("semakan_duplicate" == $table)
		return "semakan_duplicate";
	if("daftar_sek" == $table)
		return "daftar_sek";
	if("daftar_daerah" == $table)
		return "daftar_daerah";
	if("daftar_all" == $table)
		return "daftar_all";
	if("pendaftaran_murid" == $table)
		return "pendaftaran_murid";
	if("pendaftaran_sekolah" == $table)
		return "pendaftaran_sekolah";
	if("marking_AS" == $table)
		return "marking_AS";
	if("marking_BA" == $table)
		return "marking_BA";
	if("marking_JIK" == $table)
		return "marking_JIK";
	if("marking_TF" == $table)
		return "marking_TF";
	if("marking_TJ" == $table)
...
function GetTableByShort($shortTName = "")
{
	...
	if("setting" == $shortTName)
		return "setting";
	if("setting_category" == $shortTName)
		return "setting_category";
	...
	if("admin_users" == $shortTName)
		return "admin_users";
	if("analisa_kelulusan_psra_sek" == $shortTName)
		return "analisa_kelulusan_psra_sek";
	if("gps_psra_sek" == $shortTName)
		return "gps_psra_sek";
	if("analisa_subjek_psra_sek" == $shortTName)
		return "analisa_subjek_psra_sek";
	if("purata_psra_sek" == $shortTName)
		return "purata_psra_sek";
	if("analisa_kelulusan_psra_daerah" == $shortTName)
		return "analisa_kelulusan_psra_daerah";
	if("gps_psra_daerah" == $shortTName)
		return "gps_psra_daerah";
	if("analisa_subjek_psra_daerah" == $shortTName)
		return "analisa_subjek_psra_daerah";
	if("purata_psra_daerah" == $shortTName)
		return "purata_psra_daerah";
	if("analisa_kelulusan_psra_all" == $shortTName)
		return "analisa_kelulusan_psra_all";
	if("gps_psra_all" == $shortTName)
		return "gps_psra_all";
	if("analisa_subjek_psra_all" == $shortTName)
		return "analisa_subjek_psra_all";
	...
	if("archive_exam_marking" == $shortTName)
		return "archive_exam_marking";
	if("result_psra" == $shortTName)
		return "result_psra";
	if("semakan_duplicate" == $shortTName)
		return "semakan_duplicate";
	if("daftar_sek" == $shortTName)
		return "daftar_sek";
	if("daftar_daerah" == $shortTName)
		return "daftar_daerah";
	if("daftar_all" == $shortTName)
		return "daftar_all";
	if("pendaftaran_murid" == $shortTName)
		return "pendaftaran_murid";
	if("pendaftaran_sekolah" == $shortTName)
		return "pendaftaran_sekolah";
	if("marking_AS" == $shortTName)
		return "marking_AS";
	if("marking_BA" == $shortTName)
		return "marking_BA";
	if("marking_JIK" == $shortTName)
		return "marking_JIK";
	if("marking_TF" == $shortTName)
		return "marking_TF";
	if("marking_TJ" == $shortTName)
		return "marking_TJ";
